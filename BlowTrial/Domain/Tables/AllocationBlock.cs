...
{
    public enum AllocationGroups {NotApplicable = 0, India2Arm = 1, India3ArmUnbalanced=2, India3ArmBalanced=3, Brazil2Arm=4, Danish2Arm=5, Japan2Arm=6, GreenSignal2Arm=7 }
