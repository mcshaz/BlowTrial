    ...
    return new CentileData({
        ...
        lMSForAgeWeeks : function(ageWeeks, isMale)
        {
            if (isMale)
            {
                ...
                {
                    case 4:
                        return new Lms (  233.1,  4.3671, 134.97 );
                    case 5:
                        return new Lms (  223.7,  4.659, 132.15 );
                    case 6:
                        return new Lms (  215.5,  4.9303, 129.6 );
                    case 7:
                        return new Lms (  208.1,  5.1817, 127.29 );
                    case 8:
                        return new Lms (  201.4,  5.4149, 125.2 );
                    case 9:
                        return new Lms (  195.2,  5.6319, 123.3 );
                    case 10:
                        return new Lms (  189.4,  5.8346, 121.57 );
                    case 11:
                        return new Lms (  184,  6.0242, 120.01 );
                    case 12:
                        return new Lms (  178.9,  6.2019, 118.6 );
                    case 13:
                        return new Lms (  174,  6.369, 117.32 );
                    default:
                        throw ("ageWeeks");
                }
            }
