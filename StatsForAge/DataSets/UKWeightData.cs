    ...
    public sealed class UKWeightData : CentileData
    {
        ...
        protected override LMS LMSForAgeWeeks(int ageWeeks, bool isMale)
        {
            if (isMale)
            {
                ...
                {
                    case 4:
                        return new LMS { L =0.2331, M = 4.3671, S =0.13497 };
                    case 5:
                        return new LMS { L =0.2237, M = 4.659, S =0.13215 };
                    case 6:
                        return new LMS { L =0.2155, M = 4.9303, S =0.1296 };
                    case 7:
                        return new LMS { L =0.2081, M = 5.1817, S =0.12729 };
                    case 8:
                        return new LMS { L =0.2014, M = 5.4149, S =0.1252 };
                    case 9:
                        return new LMS { L =0.1952, M = 5.6319, S =0.1233 };
                    case 10:
                        return new LMS { L =0.1894, M = 5.8346, S =0.12157 };
                    case 11:
                        return new LMS { L =0.184, M = 6.0242, S =0.12001 };
                    case 12:
                        return new LMS { L =0.1789, M = 6.2019, S =0.1186 };
                    case 13:
                        return new LMS { L =0.174, M = 6.369, S =0.11732 };
                    default:
